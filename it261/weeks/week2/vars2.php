...
echo $color;
echo '<br>';
echo 'Sebastian\'s favorite color is '.$color.'';
echo '<br>';
$x = 20;
$y = 5;
$z = $x + $y;
...
$total *= 1.097;
echo $total;
echo '<h3>We would like our amount ot reflect 2 decimal places -- we are thinking about floats and a new function - number_format()</h3>';
...
// can we echo an array ??? we cannot
$fruit[] = 'bananas'; //0
$fruit[] = 'cherries'; //1
$fruit[] = 'melon'; //2
$fruit[] = 'kiwi'; //3
