...
<ul>
<li><input type="radio" name="currency" values="0.017"> Rubles</li>
<li><input type="radio" name="currency" values="0.76"> Canadian Dollars</li>
<li><input type="radio" name="currency" values="1.15"> Pounds</li>
<li><input type="radio" name="currency" values="1.00"> Euros</li>
<li><input type="radio" name="currency" values="0.0074"> Yen</li>
...
if($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    <div class="box">
    <h2> Hello '.$name.'</h2>
    <p>You now have <b>$'.floor($dollars).' American dollars</b> and we will be emailing you at <b>'.$email.'</b< with your information, as well as depositing your funds <b>'.$bank.'!</b<</p>
    </div>
    ';
    }
}
