...
// eventually will have an include('includes/header.php')

$iConn= mysqli_connection(DB_HOST, DB_USER, DB_PASSWORD, DB_NAME) or die (myError(__FILE__,__LINE__,mysqli_connect_error()));
